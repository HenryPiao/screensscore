...
export default function AboutPage() {
  return (
    <div className="container mx-auto px-4 max-w-3xl py-16">
      <h1 className="text-4xl font-black mb-8">About ReelCritic</h1>
      <div className="space-y-6 text-gray-300 leading-relaxed">
        <p className="text-lg">
          ReelCritic is your honest, no-nonsense guide to movies and TV shows. We believe your time is
        ...
        <p>
          Anyone can leave a review on ReelCritic — no sign-up required. Real viewers, real opinions.
        ...
        <p>
          ...
          <a href="mailto:hello@reelcritic.com" className="text-red-400 hover:text-red-300">
            hello@reelcritic.com
          </a>
        </p>
      </div>
    </div>
